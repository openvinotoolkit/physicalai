...
- Studio and Runtime must keep this contract synchronized. If this file is mirrored from Studio, CI should fail when copies diverge.

## Compatibility Rules

- Do not change metadata field names or semantics without coordinating Studio changes.
