...
.. deprecated::
    Legacy helpers (:mod:`~physicalai.config.loading`, :mod:`~physicalai.config.mixin`,
    YAML helpers, and related exports) remain temporarily and emit
    :class:`DeprecationWarning`. New code should use jsonargparse and
    :class:`Config` directly.
"""
...
# Public alias: recipe-shape validation (not the transport envelope helper).
